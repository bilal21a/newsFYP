...
<html lang="en">
    <head>
        ...
        <link href="http://127.0.0.1:8000/css/footer.css "rel="stylesheet">
    ...
    <body>
                    ...
                    <div class="block block-rounded block-link-pop" style="background-color: #f5f5f5;">
                        ...
                        <div class="block-content">
                            ...
                            <div >Allow me to begin by stating that, in most situations, I wouldn’t insert myself into a debate that is already saturated by the opinions of Salman Raja; Feisal Naqvi; and Salahuddin Ahmed. However, seeing as how the debate curls around the totem of merit, I would hope that relative inexperience will not disqualify this brief offering – much of which only considers existing points from a different perspective.
                                ...
                                Much of the temptation to pick seniority is a product of looking at the issue from the wrong end. The right judge can be chosen by the wrong system, and the wrong judge might be chosen through the right system. This is why either side can quote examples of judges to support its argument. The point is to pick the system that picks the right judge more often than the alternatives.</div>
                                <div class="row">
                                <div class="col-md-12">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="d-flex flex-column comment-section">
                                                        <div class="bg-white p-2">
                                                            <div class="d-flex flex-row user-info"><img class="rounded-circle" src="https://dw3i9sxi97owk.cloudfront.net/homepage/user_stories/santamaria/santamaria-avatar_96x96.webp" width="40">
                                ...
                                <div class="block-content pb-3" style="padding-top: 0">
                                    <div class="row round1">
                                        ...
                                        <div class="col-sm-12 " >
                                            ...
                                            <hr><small><i class="far fa-clock"> 12-09-2020</i></small>
                                        </div>
                                    </div>
                                </div>
                            </a>
        ...
        <script src="http://127.0.0.1:8000/js/plugins/chart.js/Chart.bundle.min.js"></script>
        <script src="http://127.0.0.1:8000/js/pages/be_pages_dashboard.min.js"></scrip>
